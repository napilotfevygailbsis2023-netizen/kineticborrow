...
<aside class="sidebar">
  ...
  <a href="handler_profile.php" style="text-decoration:none" title="View Profile"><div class="sidebar-handler" style="cursor:pointer;transition:background .18s" onmouseover="this.style.background='#0E3E42'" onmouseout="this.style.background=''">
  ...
  <nav class="sidebar-nav">
    ...
    <a class="nav-item <?= $menu_label==='profile'?'active':'' ?>" href="handler_profile.php">
